...
import 'package:link_on/components/linear_progress_indicator.dart';
                    ...
                    child: userHasVoted.value || hasPollEnded.value
                        ? Container(
                            ...
                            child: LinearPercentIndicator(
                              isRTL: isArabic(pollTitle) ? true : false,
                              ...
                              center: Container(
                                ...
                                child: Directionality(
                                  textDirection: isArabic(pollTitle)
                                      ? TextDirection.rtl
                                      : TextDirection.ltr,
                                  child: Row(
                                    children: [
